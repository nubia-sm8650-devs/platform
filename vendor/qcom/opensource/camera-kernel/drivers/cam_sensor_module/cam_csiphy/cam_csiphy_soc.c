	...
	struct csiphy_device *csiphy_dev)
{
	...
	if (of_device_is_compatible(soc_info->dev->of_node, "qcom,csiphy-v2.1.0")) {
		...
		csiphy_dev->is_divisor_32_comp = true;
		csiphy_dev->clk_lane = 0;
	} else if (of_device_is_compatible(soc_info->dev->of_node, "qcom,csiphy-v2.2.0_z60u_tele")) {
		csiphy_dev->ctrl_reg = &ctrl_reg_2_2_0_z60u_tele;
		csiphy_dev->hw_version = CSIPHY_VERSION_V220;
		csiphy_dev->is_divisor_32_comp = true;
		csiphy_dev->clk_lane = 0;
	} else if (of_device_is_compatible(soc_info->dev->of_node, "qcom,csiphy-v2.2.0_gn5_wifi")) {
		csiphy_dev->ctrl_reg = &ctrl_reg_2_2_0_gn5_wifi;
		csiphy_dev->hw_version = CSIPHY_VERSION_V220;
		csiphy_dev->is_divisor_32_comp = true;
		csiphy_dev->clk_lane = 0;
	} else {
