...
#ifdef CONFIG_VENDOR_ZTE_DEV_MONITOR_SYSTEM
static struct zlog_mod_info zlog_aw882xx_dev = {
	.module_no = ZLOG_MODULE_SMARTPA,
	.name = "SMARTPA",
	.device_name = "awinic_smartpa",
	.ic_name = "aw882xx",
	.module_name = "AWINIC",
	.fops = NULL,
};
...
#ifdef CONFIG_VENDOR_ZTE_DEV_MONITOR_SYSTEM
		zlog_client_record(aw882xx->zlog_aw882xx_client, "aw882xx i2c master send error ret=%d",ret);
		zlog_client_notify(aw882xx->zlog_aw882xx_client, ZLOG_SMARTPA_I2C_W_ERROR_NO);
#endif
	}
	kfree(data);
...
static int aw882xx_dynamic_create_controls(struct aw882xx *aw882xx)
{
	...
	aw882xx_dev_control[3].info = aw882xx_hal_monitor_work_info;
	aw882xx_dev_control[3].get = aw882xx_hal_monitor_work_get;
	aw882xx_dev_control[3].put = aw882xx_hal_monitor_work_set;
				...
				const struct i2c_device_id *id)
{
	...
	if (!aw882xx->zlog_aw882xx_client) {
		aw_dev_err(&i2c->dev, "zlog register client zlog_aw882xx_dev fail\n");
	}
#endif
