...
#define DUAL_RAM_TEST
#define KERNEL_OVER_5_10
#define DUAL_CURRENT_DIRECTION_OPPOSITE
/*********************************************************
 *
 * Conditional Marco
 *
...
#define AW8693X_BST_VOL_MIN			(0x05)
#define AW8693X_BST_VOL_MAX			(0x19)
...
#define TIKTAP_RTP_MIX_MODE			_IO(RICHTAP_IOCTL_GROUP, 0x13)
...
#ifdef DUAL_RTP_TEST
extern void aw8693x_broadcast_config(struct aw_haptic *aw_haptic, bool flag, uint8_t play_mode);
#endif
...
extern void aw_control_irq(struct aw_haptic *aw_haptic, bool en_flag);
