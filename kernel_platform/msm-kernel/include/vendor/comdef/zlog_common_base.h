...
#define ZLOG_SENSOR_SENSORHUB_RW_ERROR_NO	(8 | ZLOG_COMB_WARN_FLAG)
...
#define ZLOG_F2FS_INVALID_BLK_ADDR				(260 | ZLOG_COMB_ERR_FLAG)
#define ZLOG_F2FS_NAT_IS_CORRUPT				(261 | ZLOG_COMB_ERR_FLAG)
#define ZLOG_F2FS_BITMAP_IS_WRONG				(262 | ZLOG_COMB_ERR_FLAG)
#define ZLOG_F2FS_BITMAP_WRONGLY_CLEARED			(263 | ZLOG_COMB_ERR_FLAG)
#define ZLOG_F2FS_SIT_IS_CORRUPTED				(264 | ZLOG_COMB_ERR_FLAG)
...
/* LED */
#define ZLOG_LED_WATCHDOG_WARN_NO				(601 | ZLOG_COMB_WARN_FLAG)
